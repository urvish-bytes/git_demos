...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2019 at 01:58 PM
...
--
-- Table structure for table `multix_user`
--

CREATE TABLE `multix_user` (
...
(1, 'When should I make the booking?', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis. Duo volutpat imperdiet ut, postea salutatus imperdiet ut per, ad utinam debitis invenire has.', 'Yes'),
(2, 'How can I pay?', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis. Duo volutpat imperdiet ut, postea salutatus imperdiet ut per, ad utinam debitis invenire has.', 'Yes'),
...
(4, 'How many pieces of luggage I\'m permitted?', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has. Latine propriae quo no, unum ridens expetenda id sit, at usu eius eligendi singulis. Sea ocurreret principes ne. At nonumy aperiri pri, nam quodsi copiosae intellegebat et, ex deserunt euripidis usu. Per ad ullum lobortis. Duo volutpat imperdiet ut, postea salutatus imperdiet ut per, ad utinam debitis invenire has..    ', 'Yes'),
...
(9, 'testQ', '<p>testtttQq</p>', 'Yes'),
(10, 'testtt', 'testtttq', 'Yes'),
(12, 'ttqq', 'ttqq', 'Yes'),
(13, 'title', 'content', 'Yes'),
(14, 'testQqq', 'bghvjn', 'No');
...
(3, 'SECURITY PROTECTION', 'Mei ut errem legimus periculis, eos liber epicurei necessitatibus eu, facilisi postulant vel no.', ''),
...
--
-- Table structure for table `tbl_page_product`
--

CREATE TABLE `tbl_page_product` (
  `id` int(11) NOT NULL,
  `product_heading` varchar(255) NOT NULL,
  `mt_product` varchar(255) NOT NULL,
  `md_product` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_page_product`
--

INSERT INTO `tbl_page_product` (`id`, `product_heading`, `mt_product`, `md_product`) VALUES
(1, 'PRODUCT', 'PRODUCT - Multix - Multipurpose Website CMS with Codeigniter', 'Meta description of the product');
...
(2, 'product 2', 'this is product description 2', 450),
(4, 'product 1', '<p>test description</p><p></p>', 640),
(5, 'product 11', '<p>this is  Description of product 11</p>', 564),
(6, 'Test Product', '<p>hgdsrebvuib&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>', 640),
(14, ' Name ', ' Description ', 900),
(17, 'text', 'When can a software mend a dispute? Does a defect open the incomprehensible meat? The sport fusses throughout our drum! A cook rewrites the lasting cloud in the boy. Another tourist wild inverts her overlap. Around the vain dines the understood exhibit.', 640),
(18, 'Test Product', 'test product', 640);
...
--
-- Indexes for table `multix_user`
--
ALTER TABLE `multix_user`
...
--
-- Indexes for table `tbl_page_product`
--
ALTER TABLE `tbl_page_product`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `multix_user`
--
ALTER TABLE `multix_user`
...
--
-- AUTO_INCREMENT for table `tbl_page_product`
--
ALTER TABLE `tbl_page_product`

<div id="languages">
    ...
    ?>
    <a href="javascript:void(0);" data-toggle="modal" data-target="#add_edit_articles" class="btn btn-primary btn-sm pull-right" style="margin-bottom:10px;"><b>+</b> Add shop categorie</a>
                ...
                foreach ($shop_categories as $key_cat => $shop_categorie) {
                    ...
                    foreach ($shop_categorie['info'] as $ff) {
                        $catName .= '<div>'
                                ...
                                . '<a href="javascript:void(0);" class="editCategorie" data-indic="' . $i . '" data-for-id="' . $id . '" data-abbr="' . $ff['abbr'] . '" data-toggle="tooltip" data-placement="top" title="Edit this categorie">'
                    ...
                    <tr>
                        ...
                        <td><?= $catName ?></td>
                        <td> 
                            <a href="javascript:void(0);" class="editCategorieSub" data-sub-for-id="<?= $key_cat ?>" data-toggle="tooltip" data-placement="top" title="Edit this Subcategorie"> 
                                <i class="fa fa-pencil" style="color:green;" aria-hidden="true"></i>
                            </a> &nbsp;
                        ...
                        <td>
                            <a href="javascript:void(0);" class="editPosition" data-position-for-id="<?= $key_cat ?>" data-my-position="<?= $shop_categorie['position'] ?>" data-toggle="tooltip" data-placement="top" title="Edit position of categorie"> 
                                <i class="fa fa-pencil" style="color:green;" aria-hidden="true"></i>
                            </a> &nbsp;
                            <span id="position-<?= $key_cat ?>"><?= $shop_categorie['position'] ?></span>
                        </td>
                        <td class="text-center">
                            <a href="<?= base_url('admin/shopcategories/?delete=' . $key_cat) ?>" class="btn btn-danger btn-xs confirm-delete"><span class="glyphicon glyphicon-remove"></span> Delete</a>
                        </td>
                    </tr>
                    <?php
                }

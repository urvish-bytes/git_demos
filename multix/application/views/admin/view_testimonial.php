...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/testimonial/add" class="btn btn-primary btn-md">Add Testimonial</a>
	</div>
</section>
								...
								foreach ($testimonial as $row) {
									...
									<tr>
										...
										<td>										
											...
											<a href="<?php echo base_url(); ?>admin/testimonial/delete/<?php echo $row['id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure want to delete?');">Delete</a>
										</td>
									</tr>
								<?php }
							?>							

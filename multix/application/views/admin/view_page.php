        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab_17" data-toggle="tab">Product</a></li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_17">
                        <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Product Heading </label>
                            <div class="col-sm-6">
                                <input type="text" name="product_heading" class="form-control" value="<?php echo $page_product['product_heading']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Meta Title </label>
                            <div class="col-sm-9">
                                <input type="text" name="mt_product" class="form-control" value="<?php echo $page_product['mt_product']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Meta Description </label>
                            <div class="col-sm-9">
                                <textarea class="form-control" name="md_product" style="height:60px;"><?php echo $page_product['md_product']; ?></textarea>
                            </div>
                        </div>  
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label"></label>

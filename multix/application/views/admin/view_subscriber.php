							...
							<?php
								...
								foreach ($active_subscribers as $row) {
									...
									<tr>
								        ...
								        <td>
								            <a href="<?php echo base_url(); ?>admin/subscriber/delete/<?php echo $row['subs_id']; ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure want to delete?');">Delete</a>  
								        </td>
								    </tr>
								<?php }
							?>

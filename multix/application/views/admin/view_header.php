	...
	<div class="wrapper">
		<header class="main-header">
			...
			<nav class="navbar navbar-static-top">
				...
				<!-- <span style="line-height:50px;color:#fff;padding-left:15px;font-size:20px;">Admin Panel</span> -->
    		...
    		<section class="sidebar">
      			<ul class="sidebar-menu">
					...
					<?php if( $this->session->userdata('role') == 'Admin' ): ?>
				        ...
				        <li class="treeview <?php if( ($class_name == 'product') ) {echo 'active';} ?>">
